...
%    135(2), 021005.
%%
function dactivation = calcFirstOrderActivationDerivative(excitation,...
                                                          activation,...
...
u = clampWithinInterval(excitation,minimumActivation,1);
a = clampWithinInterval(activation,minimumActivation,1);
tau = NaN;
